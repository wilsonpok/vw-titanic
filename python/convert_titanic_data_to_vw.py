...
with open("/Users/wilsonpok/vw_titanic/data/train.csv", "r") as infile, open("train_titanic.vw", "wb") as outfile:
...
i = 0
with open("/Users/wilsonpok/vw_titanic/data/test.csv", "r") as infile, open("test_titanic.vw", "wb") as outfile:
  reader = csv.reader(infile)
  for line in reader:
    i+= 1
    if i > 1:
